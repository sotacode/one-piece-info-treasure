    ...
    devilFruits: [
        {
            ...
            secondName: null,
            type: "Paramecia",
            description: "Allows the user's body to stretch like rubber. Eaten by Monkey D. Luffy."
        },
        {
            name: "Nika Nika no Mi",
            secondName: "Hito Hito no Mi, Model: Daibutsu",
            type: "Zoan",
            description: "Allows the user to transform into various animals and control objects. Eaten by Sengoku."
        },
        {
            name: "Mera Mera no Mi",
            secondName: null,
            type: "Logia",
            description: "Grants control over fire and the ability to become fire. Previously eaten by Portgas D. Ace, currently by Sabo."
        },
        {
            name: "Hie Hie no Mi",
            secondName: null,
            type: "Logia",
            description: "Grants control over ice and the ability to become ice. Eaten by Kuzan (Aokiji)."
        },
        {
            name: "Yami Yami no Mi",
            secondName: null,
            type: "Logia",
            description: "Grants control over darkness and the ability to create black holes. Eaten by Marshall D. Teach (Blackbeard)."
        },
        {
            name: "Gura Gura no Mi",
            secondName: null,
            type: "Paramecia",
            description: "Allows the user to create earthquakes and tsunamis. Eaten by Edward Newgate (Whitebeard)."
        },
        // Agrega más frutas del diablo aquí con sus nombres y propiedades
    ],
    users: [
        {
